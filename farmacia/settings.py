...
SECRET_KEY = '0vcgvtj$=fp-@yh=%(5+)dpjr(7l8+-n8#f970&79z!b2%-3$_'
...
#al loguearse le redireccionara al siguiente enlae
LOGIN_REDIRECT_URL='medicamentos:list_medications'
